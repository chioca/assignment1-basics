from cs336_basics.train.train_engine import train, TrainingConfig, ModelConfig
from cs336_basics.train.utils import get_device, AdamW
from cs336_basics.utils import print_color, seed_everything
from cs336_basics.transformer.transformer import Transform_llm
import os
import dotenv
import fire
...
def main(
    ...
    # Initialize model
    model = Transform_llm(model_config)
